							...
							<div class="col-lg-12">
								...
								<div class=" row">
									<div class="col-md-2 col-sm-4 col-6">
										<span class="data-attr" data-peity='{ "fill": ["rgb(13,153,255)", "rgba(13,153,255,1)"], "innerRadius": 10, "radius": 40 }'>1/7</span>
									</div>
					...
					<div class="card-body pb-0">
						<div class="row">
							<div class="col-lg-4 col-md-4 pb-4">
								...
								<div class="px-4"><span class="bar" data-peity='{ "fill": ["rgb(13,153,255)", "rgba(13,153,255,1)"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
								</div>
							</div>
							<div class="col-lg-4 col-md-4 pb-4">
								<h4 class="card-title mb-4">Bar Chart</h4>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
								...
								<div class=""><span class="donut" data-peity='{ "fill": ["rgb(13,153,255)", "rgba(185,168,255,1)"]}'>5/8</span>
								</div>
							</div>
							<div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
