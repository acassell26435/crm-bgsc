					...
					<div class="profile-head">
						...
						<div class="profile-info">
							<div class="profile-photo">
								<img <?php echo base_url('public/assets/images/profile/profile.png'); ?>" class="img-fluid rounded-circle" alt="">
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="profile-blog">
									...
									<img <?php echo base_url('public/assets/images/profile/1.jpg'); ?>" alt="" class="img-fluid mt-4 mb-4 w-100 rounded">
							...
							<div class="card-body">
								<div class="profile-interest">
									...
									<div class="row mt-4 sp4" id="lightgallery">
										<a href="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img <?php echo base_url('public/assets/images/profile/2.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img <?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img <?php echo base_url('public/assets/images/profile/4.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" alt="" class="img-fluid rounded">
										</a>
									</div>
								</div>
							</div>
