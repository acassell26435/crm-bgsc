                                    ...
                                    <table id="projects-tbl" class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo base_url('public/assets/images/contacts/pic1.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                                        <div class="ms-2">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="<?php echo base_url('public/assets/images/profile/friends/f1.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                                        <div class="ms-2">
