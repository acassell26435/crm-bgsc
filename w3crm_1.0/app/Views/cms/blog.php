            ...
            <div class="col-xl-12">
                ...
                <div class="mb-3">
                    <ul class="d-flex align-items-center flex-wrap">
                        <li><a href="<?php echo site_url('/add_blog'); ?>" class="btn btn-primary ">Add Blog</a></li>
                        <li><a href="<?php echo site_url('/blog_category'); ?>" class="btn btn-primary mx-1">Blog Category</a></li>
                        <li><a href="<?php echo site_url('/blog_category'); ?>" class="btn btn-primary mt-sm-0 mt-1">Add Blog Category</a></li>
                    </ul>
                </div>
                <div class="filter cm-content-box box-primary">
                    <div class="content-title">
