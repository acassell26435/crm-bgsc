		...
		<ul class="metismenu" id="menu">
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('/'); ?>">Dashboard Light</a></li>
					<li><a href="<?php echo site_url('index_2'); ?>">Dashboard Dark</a></li>
				</ul>
			</li>
			<li><a href="<?php echo site_url('employee'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
			...
			<li><a href="<?php echo site_url('/core_hr'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a href="<?php echo site_url('/finance'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('/task'); ?>">Tasks</a></li>
					<li><a href="<?php echo site_url('/task_summary'); ?>">Task Summary</a></li>
				</ul>
			</li>
			<li><a href="<?php echo site_url('/performance'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a href="<?php echo site_url('/project'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a href="<?php echo site_url('/reports'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a href="<?php echo site_url('/manage_clients'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a href="<?php echo site_url('/blog_1'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
			...
			<li><a href="<?php echo site_url('/svg_icon'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('/chat'); ?>">Chat<span class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
						<ul aria-expanded="false">
							...
							<li><a href="<?php echo site_url('/user_roles'); ?>">Roles Listing </a></li>
							<li><a href="<?php echo site_url('/app_profile_1'); ?>">Profile 1</a></li>
							<li><a href="<?php echo site_url('/app_profile_2'); ?>">Profile 2 <span class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
							<li><a href="<?php echo site_url('/edit_profile'); ?>">Edit Profile</a></li>
							<li><a href="<?php echo site_url('/post_details'); ?>">Post Details</a></li>
						</ul>
					</li>
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Customer Manager<span class="badge badge-danger badge-xs ms-1">NEW</span></a>
						<ul aria-expanded="false">
							...
							<li><a href="<?php echo site_url('customer_profile'); ?>">Customer Profile</a></li>
						</ul>
					</li>
					<li><a href="<?php echo site_url('contacts'); ?>">Contacts <span class="badge badge-danger badge-xs ms-1">NEW</span></a></li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Email</a>
						<ul aria-expanded="false">
							<li><a href="<?php echo site_url('email_compose'); ?>">Compose</a></li>
							<li><a href="<?php echo site_url('email_inbox'); ?>">Inbox</a></li>
							<li><a href="<?php echo site_url('email_read'); ?>">Read</a></li>
						</ul>
					</li>
					<li><a href="<?php echo site_url('app_calendar'); ?>">Calendar</a></li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
						<ul aria-expanded="false">
							<li><a href="<?php echo site_url('ecom_product_grid'); ?>">Product Grid</a></li>
							<li><a href="<?php echo site_url('ecom_product_list'); ?>">Product List</a></li>
							<li><a href="<?php echo site_url('ecom_product_details'); ?>">Product Details</a></li>
							<li><a href="<?php echo site_url('ecom_product_order'); ?>">Order</a></li>
							<li><a href="<?php echo site_url('ecom_checkout'); ?>">Checkout</a></li>
							<li><a href="<?php echo site_url('ecom_invoice'); ?>">Invoice</a></li>
							<li><a href="<?php echo site_url('ecom_customers'); ?>">Customers</a></li>
						</ul>
					</li>
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('/auto_write'); ?>">Auto Writer</a></li>
					<li><a href="<?php echo site_url('/scheduled'); ?>">Scheduler</a></li>
					<li><a href="<?php echo site_url('/repurpose'); ?>">Repurpose</a></li>
					<li><a href="<?php echo site_url('/rss'); ?>">RSS</a></li>
					<li><a href="<?php echo site_url('/chatbot'); ?>">Chatbot</a></li>
					<li><a href="<?php echo site_url('/fine_tune_models'); ?>">Fine-tune Models</a></li>
					<li><a href="<?php echo site_url('/prompt'); ?>">AI Menu Prompts</a></li>
					<li><a href="<?php echo site_url('/setting'); ?>">Settings</a></li>
					<li><a href="<?php echo site_url('/import'); ?>">Export/Import Settings</a></li>
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				<div class="menu-icon">
				...
				<li><a href="<?php echo site_url('/content'); ?>">Content</a></li>
                    <li><a href="<?php echo site_url('/add_content'); ?>">Add Content</a></li>
                    <li><a href="<?php echo site_url('/menu'); ?>">Menu</a></li>
                    <li><a href="<?php echo site_url('/email_template'); ?>">Email Template</a></li>
                    <li><a href="<?php echo site_url('/add_email'); ?>">Add Email</a></li>
                    <li><a href="<?php echo site_url('/blog'); ?>">Blog</a></li>
                    <li><a href="<?php echo site_url('/add_blog'); ?>">Add Blog</a></li>
                    <li><a href="<?php echo site_url('/blog_category'); ?>">Blog Category</a></li>	
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				<div class="menu-icon">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('flot'); ?>">Flot</a></li>
					<li><a href="<?php echo site_url('morris'); ?>">Morris</a></li>
					<li><a href="<?php echo site_url('chartjs'); ?>">Chartjs</a></li>
					<li><a href="<?php echo site_url('chartist'); ?>">Chartist</a></li>
					<li><a href="<?php echo site_url('sparkline'); ?>">Sparkline</a></li>
					<li><a href="<?php echo site_url('peity'); ?>">Peity</a></li>
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				<div class="menu-icon">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('accordion'); ?>">Accordion</a></li>
					<li><a href="<?php echo site_url('alert'); ?>">Alert</a></li>
					<li><a href="<?php echo site_url('badge'); ?>">Badge</a></li>
					<li><a href="<?php echo site_url('button'); ?>">Button</a></li>
					<li><a href="<?php echo site_url('modal'); ?>">Modal</a></li>
					<li class="extra-menu-li">		
						<ul id="collapseExample" class="pt-0 extra-menu-links extra-menu-area">
						<li><a href="<?php echo site_url('button_group'); ?>">Button Group</a></li>
							<li><a href="<?php echo site_url('list_group'); ?>">List Group</a></li>
							<li><a href="<?php echo site_url('card'); ?>">Cards</a></li>
							<li><a href="<?php echo site_url('carousel'); ?>">Carousel</a></li>
							<li><a href="<?php echo site_url('dropdown'); ?>">Dropdown</a></li>
							<li><a href="<?php echo site_url('popover'); ?>">Popover</a></li>
							<li><a href="<?php echo site_url('progressbar'); ?>">Progressbar</a></li>
							<li><a href="<?php echo site_url('tab'); ?>">Tab</a></li>
							<li><a href="<?php echo site_url('typography'); ?>">Typography</a></li>
							<li><a href="<?php echo site_url('pagination'); ?>">Pagination</a></li>
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('select2'); ?>">Select 2</a></li>
					<li><a href="<?php echo site_url('nestable'); ?>">Nestable</a></li>
					<li><a href="<?php echo site_url('noui_slider'); ?>">Noui Slider</a></li>
					<li><a href="<?php echo site_url('sweetalert'); ?>">Sweet Alert</a></li>
					<li><a href="<?php echo site_url('toastr'); ?>">Toastr</a></li>
					<li><a href="<?php echo site_url('map_jqvmap'); ?>">Jqv Map</a></li>
					<li><a href="<?php echo site_url('lightgallery'); ?>">Light Gallery</a></li>
				</ul>
			</li>
			<li><a href="<?php echo site_url('widget_basic'); ?>" class="" aria-expanded="false">
				<div class="menu-icon">
					<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('form_element'); ?>">Form Elements</a></li>
					<li><a href="<?php echo site_url('form_wizard'); ?>">Wizard</a></li>
					<li><a href="<?php echo site_url('form_ckeditor'); ?>">CkEditor</a></li>
					<li><a href="<?php echo site_url('form_pickers'); ?>">Pickers</a></li>
					<li><a href="<?php echo site_url('form_validation_jquery'); ?>">Jquery Validate</a></li>
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				<div class="menu-icon">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('table_bootstrap'); ?>">Bootstrap</a></li>
					<li><a href="<?php echo site_url('table_datatable'); ?>">Datatable</a></li>
				</ul>
			</li>
			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
				<div class="menu-icon">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo site_url('page_login'); ?>">Login</a></li>
					<li><a href="<?php echo site_url('page_register'); ?>">Register</a></li>
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Error</a>
						<ul aria-expanded="false">
							<li><a href="<?php echo site_url('page_error_400'); ?>">Error 400</a></li>
							<li><a href="<?php echo site_url('page_error_403'); ?>">Error 403</a></li>
							<li><a href="<?php echo site_url('page_error_404'); ?>">Error 404</a></li>
							<li><a href="<?php echo site_url('page_error_500'); ?>">Error 500</a></li>
							<li><a href="<?php echo site_url('page_error_503'); ?>">Error 503</a></li>
						</ul>
					</li>
					<li><a href="<?php echo site_url('page_lock_screen'); ?>">Lock Screen</a></li>
					<li><a href="<?php echo site_url('page_empty'); ?>">Empty Page</a></li>
				</ul>
			</li>
		</ul>
		<div class="help-desk">
