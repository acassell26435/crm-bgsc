        ...
        <div class="row">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex align-items-center">
                    <div class="icon-box  icon-box-sm bg-secondary me-2">
                        <a href="<?php echo site_url('/task_summary'); ?>">
                ...
                <div class="card box-hover">
                    ...
                    <div class="card-body">
                        <div class="products style-1">
                            <img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-lg rounded-circle" alt="">
                            <div>
                                <h6>Cedric Kelly</h6>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card box-hover">
                    ...
                    <div class="card-body">
                        <div class="products style-1">
                            <img src="<?php echo base_url('public/assets/images/contacts/pic1.jpg'); ?>" class="avatar avatar-lg rounded-circle" alt="">
                            <div>
                                <h6>Cedric Kelly</h6>
                                <span>06 Feb 2023</span>	
                            </div>	
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card box-hover">
                    ...
                    <div class="card-body">
                        <div class="products style-1">
                            <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-lg rounded-circle" alt="">
                            <div>
                                <h6>Cedric Kelly</h6>
                                <span>06 Feb 2023</span>	
                            </div>	
