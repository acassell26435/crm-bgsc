...
<div class="content-body">
	<div class="page-titles">
		<nav aria-label="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page"><?php echo !empty($page_title) ? $page_title : ''; ?></li>
			</ol>
		</nav>
	</div>
											...
											<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
												...
												<div class="carousel-inner">
													<div class="carousel-item active">
														<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img1.jpg'); ?>" alt="First slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img2.jpg'); ?>" alt="Second slide">
													</div>
													<div class="carousel-item">
														<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img3.jpg'); ?>" alt="Third slide">
													</div>
												</div>
										...
										<div class="card-body pt-0 p-4">
											<div class="bootstrap-carousel">
												<div class="carousel slide" data-bs-ride="carousel">
													<div class="carousel-inner">
														<div class="carousel-item active">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img2.jpg'); ?>" alt="First slide">
														...
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img3.jpg'); ?>" alt="Second slide">
															<div class="carousel-caption d-none d-md-block">
														...
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img4.jpg'); ?>" alt="Third slide">
															<div class="carousel-caption d-none d-md-block">
										...
										<div class="card-body pt-0 p-4">	
											<div class="bootstrap-carousel">
												<div class="carousel slide" data-bs-ride="carousel">
													<div class="carousel-inner">
														<div class="carousel-item active">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img3.jpg'); ?>" alt="First slide">
														</div>
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img4.jpg'); ?>" alt="Second slide">
														</div>
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img5.jpg'); ?>" alt="Third slide">
														</div>
													</div>
												</div>
											</div>
										...
										<div class="card-body pt-0 p-4">
											<div class="bootstrap-carousel">
												<div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
													...
													<div class="carousel-inner">
														<div class="carousel-item active">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img4.jpg'); ?>" alt="First slide">
														</div>
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img5.jpg'); ?>" alt="Second slide">
														</div>
														<div class="carousel-item">
															<img class="d-block w-100 rounded" src="<?php echo base_url('public/assets/images/big/img6.jpg'); ?>" alt="Third slide">
														</div>
													</div>
