			...
			<div class="col-xl-12">
				<div class="mb-3">
					<ul class="d-flex align-items-center flex-wrap">
						<li><a href="<?php echo site_url('/add_email'); ?>" class="btn btn-primary">Blog List</a></li>
						<li><a href="<?php echo site_url('/blog_category'); ?>" class="btn btn-primary mx-1">Blog Category</a></li>
						<li><a href="<?php echo site_url('/blog_category'); ?>" class="btn btn-primary me-1 mt-sm-0 mt-1">Add Blog Category</a></li>
