											...
											<a href="#">
												<div class="media d-flex align-items-center">
													<div class="avatar avatar-sm me-2">
														<div class=""><img class="rounded-circle img-fluid" src="<?php echo base_url('public/assets/images/avatar/5.png'); ?>" width="30" alt="">
														</div>
													</div>
									...
									<tr class="btn-reveal-trigger">
										...
										<td class="py-3">
											<a href="#">
												<div class="media d-flex align-items-center">
													<div class="avatar avatar-sm me-2">
														<img class="rounded-circle img-fluid" src="<?php echo base_url('public/assets/images/avatar/1.png'); ?>" alt="" width="30">
													</div>
													<div class="media-body">
