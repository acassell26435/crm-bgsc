							...
							<div class="col-xl-3 col-lg-6 col-md-6">
								...
								<div class="tab-content" id="myTabContent">
									<div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
											<img class="img-fluid rounded  " src="<?php echo base_url('public/assets/images/product/1.jpg'); ?>" alt="">
									</div>
									<div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
										<img class="img-fluid rounded " src="<?php echo base_url('public/assets/images/product/2.jpg'); ?>" alt="">
									</div>
									<div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
										<img class="img-fluid rounded" src="<?php echo base_url('public/assets/images/product/3.jpg'); ?>" alt="">
									</div>
								...
								<div class="tab-slide-content new-arrival-product mb-4 mb-xl-0">
									...
									<ul class="nav nav-tabs slide-item-list mt-3" id="myTab" role="tablist">
											...
											<a href="#first" class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"  role="tab" aria-controls="home-tab-pane" aria-selected="true"><img class="img-fluid me-2 rounded" src="<?php echo base_url('public/assets/images/tab/1.jpg'); ?>" alt="" width="80"></a>
											</li>
											<li class="nav-item" role="presentation">
											<a href="#second" class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"  role="tab" aria-controls="profile-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="<?php echo base_url('public/assets/images/tab/2.jpg'); ?>" alt="" width="80"></a>
											</li>
											<li class="nav-item" role="presentation">
											<a href="#third" class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane" role="tab" aria-controls="contact-tab-pane" aria-selected="false"><img class="img-fluid me-2 rounded" src="<?php echo base_url('public/assets/images/tab/3.jpg'); ?>" alt="" width="80"></a>
											</li>
											<li class="nav-item" role="presentation">
											<a href="#for" class="nav-link" id="end-tab" data-bs-toggle="tab" data-bs-target="#end-tab-pane"  role="tab" aria-controls="end-tab-pane" aria-selected="false"><img class="img-fluid  rounded" src="<?php echo base_url('public/assets/images/tab/4.jpg'); ?>" alt="" width="80"></a>
											</li>
