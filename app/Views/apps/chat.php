                        ...
                        <div class="row gx-0">
                            ...
                            <div class="col-xl-3 col-lg-6 col-sm-5 chat-border mobile-chat chat-left-area">
                                <div class="chat-p shaprate">
                                    <div class="d-flex">
                                        <img src="<?php echo base_url('public/assets/images/contacts/d1.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                        <div class="ms-2">
                                ...
                                <div class="people-list dz-scroll">
                                    ...
                                    <div class="chat-p style-1">
                                        <div class="d-flex active">
                                            <img src="<?php echo base_url('public/assets/images/contacts/d4.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                            <div class="ms-2">
                                    ...
                                    <div class="chat-p style-1">
                                        <div class="d-flex">
                                            <img src="<?php echo base_url('public/assets/images/contacts/d2.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
                                            <div class="ms-2">
                            ...
                            <div class="col-xl-4">
                                <div class="chat-meadia">
                                    ...
                                    <div class="image-list">
                                        <img src="<?php echo base_url('public/assets/images/chat/1.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/3.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/2.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/5.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/4.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/2.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/4.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/1.png'); ?>" alt="">
                                        <img src="<?php echo base_url('public/assets/images/chat/4.png'); ?>" alt="">
                                ...
                                <div class="chat-meadia">
                                    ...
                                    <div class="file-list row dz-scroll">
                                        <div class="text-center col-xl-4 col-6 filie-l-icon">
                                            <img src="<?php echo base_url('public/assets/images/chat/google-docs1.png'); ?>" alt="">
                                            <h5>document.doc</h5>
                                            <span>3 Items December 27th, 2021 04:56 AM - 10.0 MB</span>
                                        </div>
                                        <div class="text-center col-xl-4 col-6 filie-l-icon">
                                            <img src="<?php echo base_url('public/assets/images/chat/play-button1.png'); ?>" alt="">
                                            <h5>document.doc</h5>
                                            <span>3 Items December 27th, 2021 04:56 AM - 10.0 MB</span>
                                        </div>
                                        <div class="text-center col-xl-4 col-6 filie-l-icon">
                                            <img src="<?php echo base_url('public/assets/images/chat/music-notes1.png'); ?>" alt="">
                                            <h5>document.doc</h5>
                                            <span>3 Items December 27th, 2021 04:56 AM - 10.0 MB</span>
                                        </div>
                                        <div class="text-center col-xl-4 col-6 filie-l-icon">
                                            <img src="<?php echo base_url('public/assets/images/chat/pdf.png'); ?>" alt="">
                                            <h5>Project 01</h5>
                                            <span>3 Items December 27th, 2021 04:56 AM - 10.0 MB</span>
                                        </div>
                                        <div class="text-center col-xl-4 col-6 filie-l-icon">
