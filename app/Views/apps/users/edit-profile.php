                ...
                <div class="clearfix">
                    <div class="card card-bx profile-card author-profile m-b30">
                        <div class="card-body">
                            <div class="p-5">
                                <div class="author-profile">
                                    <div class="author-media">
                                        <img src="<?php echo base_url('public/assets/images/tab/1.jpg'); ?>" alt="">
                            ...
                            <div class="info-list">
                                <ul>
                                    <li><a href="<?php echo site_url('/app_profile_1'); ?>">Models</a><span>36</span></li>
                                    <li><a href="<?php echo site_url('/uc_lightgallery'); ?>">Gallery</a><span>3</span></li>
                                    <li><a href="<?php echo site_url('/app_profile_1'); ?>">Lessons</a><span>1</span></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card profile-card card-bx m-b30">
                    ...
                    <form class="profile-form">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo site_url('/page_register'); ?>" class="btn-link">Forgot your password?</a>
                        </div>
                    </form>
                </div>
            </div>
