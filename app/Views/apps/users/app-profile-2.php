				...
				<div class="card card-profile">
					<div class="admin-user">
						<div class="img-wrraper">                              
							<div class="">
								<img src="<?php echo base_url('public/assets/images/user1.jpg'); ?>" class="rounded-circle"></div>
							<a class="icon-wrapper" href="<?php echo site_url('/edit_profile'); ?>"><i class="fa-solid fa-pencil"></i></a>
						</div>
											...
											<div class="about-me">
												<ul>
													...
													<div>
														...
														<a href="javascript:void(0)" class="btn btn-block bg-facebook mb-2"><i class="fa-brands fa-skype me-2"></i>Skype</a>
													</div>
												</ul>
											</div>
												...
												<div class="profile-interest">
													<div class="row mt-4 sp4" id="lightgallery">
														<a href="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
															<img src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" alt="" class="px-1 py-1 img-fluid rounded">
														</a>
														<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
															<img src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="px-1 py-1 img-fluid rounded">
														</a>
														<a href="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
															<img src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" alt="" class="px-1 py-1 img-fluid rounded">
														</a>
														<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
															<img src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="px-1 py-1 img-fluid rounded">
														</a>
												...
												<div class="profile-news">
													<div class="media pt-3 pb-3">
														...
														<div class="media-body">
															<h6 class="m-b-5"><a href="<?php echo site_url('/post_details'); ?>" class="text-black">Collection of textile samples</a></h6>
										...
										<div id="collapseOne6" class="accordion-collapse collapse show" aria-labelledby="headingOne6" data-bs-parent="#accordionExample6">
											<div class="accordion-body">
												<div class="friend-list">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f3.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f2.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/pic1.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/d4.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f4.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f1.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f3.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
													<img src="<?php echo base_url('public/assets/images/profile/friends/f2.jpg'); ?>" class="avatar avatar-md" alt="">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header border-0">
								<div class="products">
									<img src="<?php echo base_url('public/assets/images/user1.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
									<div>
							...
							<div class="card-body pt-0">
								<div class="post-img">
									<img src="<?php echo base_url('public/assets/images/post/post1.jpg'); ?>">	
								</div>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header border-0">
								<div class="products">
									<img src="<?php echo base_url('public/assets/images/profile/friends/f2.jpg'); ?>" class="avatar avatar-md rounded-circle" alt="">
									<div>
										<h5 class="mb-0"><a href="javascript:void(0)" class="text-black">Thomas Fleming</a></h5>
										<span>8 Hours ago</span>	
									</div>	
							...
							<div class="card-body pt-0">
								<div class="row">
									<div class="col-xl-6">
										<div class="post-img">
											<img src="<?php echo base_url('public/assets/images/post/post11.jpg'); ?>" class="me-3">	
										</div>	
									</div>
									<div class="col-xl-6">
										<div class="post-img">
											<img src="<?php echo base_url('public/assets/images/post/post12.jpg'); ?>" class="ms-3">	
										</div>	
									</div>
								</div>
								<div class="post-see d-flex align-items-center mt-3">
					...
					<div class="col-xl-12">
						<div class="card">
							...
							<div class="card-body pt-0">
								<div class="post-img">
									<img src="<?php echo base_url('public/assets/images/post/post2.jpg'); ?>">	
								</div>
								<div class="post-see d-flex align-items-center mt-3">
									<ul>
									<div class="avatar-list avatar-list-stacked">
						...
						<div class="card">
							...
							<div class="card-body pt-0">
								<div class="row">
									<div class="col-xl-6">
										<div class="post-img"> 
											<img src="<?php echo base_url('public/assets/images/post/post12.jpg'); ?>" class="me-3">	
										</div>
										
									</div>
									<div class="col-xl-6">
										<div class="post-img"> 
											<img src="<?php echo base_url('public/assets/images/post/post13.jpg'); ?>" class="ms-3">	
										</div>  
									</div>
								</div>
								<div class="post-see d-flex align-items-center mt-3">
