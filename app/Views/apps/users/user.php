        ...
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?php echo site_url('/edit_profile'); ?>" class="btn btn-primary btn-sm ms-2">+ Add User</a>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                        <img src="<?php echo base_url('public/assets/images/profile/friends/f1.jpg'); ?>" class="rounded-circle" alt="">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                        <img src="<?php echo base_url('public/assets/images/user1.jpg'); ?>" class="rounded-circle" alt="">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                        <img src="<?php echo base_url('public/assets/images/profile/friends/f2.jpg'); ?>" class="rounded-circle" alt="">
                                        <div class="active"></div>
                                    </div>
                                    <div class="card__text">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                        <img src="<?php echo base_url('public/assets/images/profile/friends/f3.jpg'); ?>" class="rounded-circle" alt="">
                                        <div class="active deactive"></div>
                                    </div>
                                    <div class="card__text">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-use-box">
                                    <div class="crd-bx-img">
                                        <img src="<?php echo base_url('public/assets/images/profile/friends/f4.jpg'); ?>" class="rounded-circle" alt="">
                                        <div class="active deactive"></div>
                                    </div>
                                    <div class="card__text">
                            ...
                            <table id="user-tbl" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar rounded-circle" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo base_url('public/assets/images/user1.jpg'); ?>" class="avatar rounded-circle" alt="">
