    ...
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">
                ...
                <?php echo !empty($page_title) ? $page_title : ''; ?> </a>
            </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                ...
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Ricky Seme</a></h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                ...
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Ricky men</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic1.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Madison Jessica</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Rodriguez Jessica</a></h6>
                                                    <span>Web Doveloper</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Abigail Margaret</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Martinez Margaret</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Amelia Antony</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic1.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Ricky Olivia</a></h6>
                                                    <span>Web Doveloper</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Ricky Isla</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic3.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Emily Elizabeth</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="products">
                                                <img src="<?php echo base_url('public/assets/images/contacts/pic2.jpg'); ?>" class="avatar avatar-md" alt="">
                                                <div>
                                                    <h6><a href="<?php echo site_url('/app_profile_2'); ?>">Isabella Tracy</a></h6>
                                                    <span>Web Designer</span>	
                                                </div>	
                                            </div>
                                        </td>
