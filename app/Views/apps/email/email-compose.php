						...
						<div class="row gx-0">
							...
							<div class="col-xl-2 col-xxl-3 col-lg-3">
								<div class="email-left-box dz-scroll pt-3 ps-0" id="email-left">
									<div class="p-0">
										<a href="<?php echo site_url('email_compose'); ?>" class="btn text-white btn-block"><i class="fa-solid fa-plus me-2"></i>Compose Email</a>
									</div>
									<div class="mail-list rounded ">
										<a href="<?php echo site_url('email_inbox'); ?>" class="list-group-item active"><i class="fa-regular fa-envelope align-middle"></i>Inbox <span class="badge badge-purple badge-sm float-end rounded">2</span> </a>
									...
									<div class="mail-list rounded overflow-hidden mt-4">
										...
										<a href="<?php echo site_url('email_inbox'); ?>" class="list-group-item change">Work </a>
										<a href="<?php echo site_url('email_inbox'); ?>" class="list-group-item change">Private </a>
										<a href="<?php echo site_url('email_inbox'); ?>" class="list-group-item change">Support </a>
										<a href="<?php echo site_url('email_inbox'); ?>" class="list-group-item change">Social </a>
									</div>
								</div>
							</div>
							<!-- /column -->
